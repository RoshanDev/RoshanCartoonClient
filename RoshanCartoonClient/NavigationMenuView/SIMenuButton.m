...
//        self.title.textColor = currentStyle[UITextAttributeTextColor];
        self.title.textColor = [currentStyle objectForKey:UITextAttributeTextColor];
        self.title.textColor =[currentStyle objectForKey:UITextAttributeFont];
//        self.title.font = currentStyle[UITextAttributeFont];
//        self.title.shadowColor = currentStyle[UITextAttributeTextShadowColor];
        self.title.shadowColor = [currentStyle objectForKey:UITextAttributeTextShadowColor];
//        NSValue *shadowOffset = currentStyle[UITextAttributeTextShadowOffset];
        NSValue *shadowOffset = [currentStyle objectForKey:UITextAttributeTextShadowOffset];
